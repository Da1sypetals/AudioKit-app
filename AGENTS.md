...
## UI
任何UI相关问题你都必须**先复现**，再**尝试修复**；然后**验证**。
- 如果你有能力**验证**你的修复(包括但不限于Computer Use, 脚本等能力)，仅在验证后才允许称为修复；
- 如果你没有能力**验证**你的修复，则你做的任何事情都被称为**尝试**，而不允许声称为**修复**。
